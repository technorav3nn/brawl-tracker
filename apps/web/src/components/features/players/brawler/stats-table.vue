...
const playerStats = [
	...
	},
	{
		...
		image: "/icons/player/power-level.svg",
		color: "text-fuchsia-500! dark:text-fuchsia-400!",
	},
	{
		stat: "Coins to Max",
		value: progressToMax.value?.coins,
		image: "/icons/coins.webp",
	...
	},
	{
		...
		image: "/icons/player/brawler-powers/gadget.png",
		color: "text-green-500! dark:text-green-400!",
	},
	{
		stat: "# Of Star Powers",
		value: playerBrawler.value?.starPowers.length,
		image: "/icons/player/brawler-powers/starpower.png",
		color: "text-amber-500! dark:text-amber-400!",
	},
	{
		stat: "# Of Gears",
		value: playerBrawler.value?.gears.length,
		image: "/icons/player/brawler-powers/gear.png",
